...
# Load files
gesis_df = pd.read_csv('../data/gesis.csv')
zenodo_df = pd.read_csv('../data/zenodo.csv')
madata_df = pd.read_csv('../data/madata.csv')
harvard_df = pd.read_csv('../data/harvard_dataverse.csv')
...
# Save to CSV
unified_df.to_csv('../data/unified_mannheim_metadata.csv', index=False)
# Save your DataFrame to JSON
unified_df.to_json("../data/unified_mannheim_metadata.json", orient="records")

print("Unified metadata saved to ../data/unified_mannheim_metadata.csv")
